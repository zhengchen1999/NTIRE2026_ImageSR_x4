...
from analysis.model_zoo.glass import buildGLASS
from analysis.model_zoo.glassv2 import buildGLASSv2Small, buildGLASSv2Large,buildGLASSv2Base
from model_zoo.glass import buildGLASS_light
...
from model_zoo.glassv2 import buildGLASSv2_light
...
if __name__ == '__main__':
    ...
    W=1280
    scale=4
    init_model = buildGLASSv2Small(upscale=scale).to(device)
    with torch.no_grad():
