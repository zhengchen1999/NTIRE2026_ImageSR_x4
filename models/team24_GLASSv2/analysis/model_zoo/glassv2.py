...
def buildGLASSv2Base(upscale=2):
    return GLASSv2(img_size=64,
                   patch_size=1,
                   in_chans=3,
                   embed_dim=174,
                   d_state= 16,
...
def buildGLASSv2_light(upscale=2):
    return GLASSv2(img_size=64,
                   patch_size=1,
                   in_chans=3,
                   embed_dim=48,
...
def buildGLASSv2Small(upscale=2):
    return GLASSv2(img_size=64,
                   patch_size=1,
                   in_chans=3,
                   embed_dim=132,
...
def buildGLASSv2Large(upscale=2):
    return GLASSv2(img_size=64,
                   patch_size=1,
                   in_chans=3,
                   embed_dim=174,
