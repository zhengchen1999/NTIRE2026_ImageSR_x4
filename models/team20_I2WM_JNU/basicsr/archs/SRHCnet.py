...
from models.team20_I2WM_JNU.basicsr.archs.local_arch import Local_Base
...
class SRHCnet(nn.Module):
    ...
    def forward(self, inp_img):
        ...
        srh_out = self.srhnet(inp_img) * self.beta / self.img_range + self.mean
...
# 256=>320=>448, 64=>80=>112
class SRHCnetLocal(Local_Base, SRHCnet):
    def __init__(self, *args, train_size=(1, 3, 64, 64), fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        SRHCnet.__init__(self, *args, **kwargs)
