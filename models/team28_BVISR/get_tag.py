...
# srun --gpus=1 --ntasks=1 --time=02:00:00 --job-name=get_tags --pty python get_tag.py \
#     --ram_path /projects/b5cv/Programe/SeeSR/preset/models/ram_swin_large_14m.pth \
#     --hr_path /projects/b5cv/Programe/TADSR/preset/datasets/train_datasets/gt \
#     --lr_path /projects/b5cv/Programe/TADSR/preset/datasets/train_datasets/lr \
#     --out_txt /projects/b5cv/Programe/TADSR/preset/datasets/train_datasets/meta_info_dataset.txt


# srun --gpus=1 --ntasks=1 --time=02:00:00 --job-name=get_tags --pty python get_tag.py \
#     --ram_path /projects/b5cv/Programe/SeeSR/preset/models/ram_swin_large_14m.pth \
#     --hr_path /projects/b5cv/Programe/TADSR/preset/datasets/div2kvalDrealsrdataset/gt \
#     --lr_path /projects/b5cv/Programe/TADSR/preset/datasets/div2kvalDrealsrdataset/lr \
#     --out_txt /projects/b5cv/Programe/TADSR/preset/datasets/div2kvalDrealsrdataset/meta_info_datasetsss.txt