...
def get_closest_ratio(height: float, width: float, ratios: dict):
    ...
    # 实际上这部分不会过滤太多
    if aspect_ratio > float(closest_ratio):
        if aspect_ratio * 0.8 > float(closest_ratio):
            return None
    else:
        if (1 / aspect_ratio * 0.8) > (1 / float(closest_ratio)):
            return None
...
ASPECT_RATIO_COGVIDEO = {
    "0.67": (480, 720),
    # "1.0": (512, 512),
    # "1.67": (640, 384),
}

ASPECT_RATIO_COGVIDEO_1_5 = {
    "0.67": (768, 1360),
    # "1.0": (512, 512),
    # "1.67": (640, 384),
}

ASPECT_RATIO_COGVIDEO_1_5_multires = {
    "0.67": (768, 1360),
    "0.72": (832, 1152),
    "0.78": (896, 1152),
    "0.82": (896, 1088),
...
ASPECT_RATIOS = {
    ...
    "384":(384*384,ASPECT_RATIO_384),
    "448": (200704, ASPECT_RATIO_448),
    "360p": (230400, ASPECT_RATIO_360P),
    "512": (262144, ASPECT_RATIO_512),
    "768": (589824, ASPECT_RATIO_768),
    ...
    "default": (384*640, ASPECT_RATIO_DEFAULT),
    "768p": (768*1280, ASPECT_RATIO_768P),
    "cogvideo": (480*720, ASPECT_RATIO_COGVIDEO),
    "cogvideo_1_5": (768*1360, ASPECT_RATIO_COGVIDEO_1_5),
    "cogvideo_1_5_multi_res": (1024*1024, ASPECT_RATIO_COGVIDEO_1_5_multires),
    "mochi": (480*848, ASPECT_RATIO_MOCHI)
}
