...
class BaseTrainer:
    ...
    def init_vae(self):
        ...
        sd = torch.load("/root/autodl-tmp/HYPIR/weights/sd2_denoise_ae_encoder.pth")
    ...
    def init_discriminator(self):
        ...
        self.D.decoder.load_state_dict(load_file("/root/autodl-tmp/HYPIR/weights/HYPIR_sd2_D.safetensors"))
